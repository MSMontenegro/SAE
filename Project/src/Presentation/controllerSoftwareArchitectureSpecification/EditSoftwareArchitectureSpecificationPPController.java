...
import Presentation.preferenceSoftwareArchitectureSpecification.EditSoftwareArchitectureSpecificationPreferencePage;
 ...
 *
 */
public class EditSoftwareArchitectureSpecificationPPController extends Controller {
	/**
	 * Attributes
	 */
	private SoftwareArchitectureSpecificationManager manager;
	private EditSoftwareArchitectureSpecificationPreferencePage form;
	private static EditSoftwareArchitectureSpecificationPPController viewController;

	private EditSoftwareArchitectureSpecificationPPController() {
		super();
	 ...
	 * Getters and Setters
	 */
	public static EditSoftwareArchitectureSpecificationPPController getViewController() {
		if (viewController == null) {
			synchronized (EditSoftwareArchitectureSpecificationPPController.class) {
				viewController = new EditSoftwareArchitectureSpecificationPPController();
			}
		}
		return viewController;
	}

	public static void setViewController(EditSoftwareArchitectureSpecificationPPController viewController) {
		EditSoftwareArchitectureSpecificationPPController.viewController = viewController;
	}
	...
	public EditSoftwareArchitectureSpecificationPreferencePage getForm() {
		return form;
	}

	public void setForm(EditSoftwareArchitectureSpecificationPreferencePage form) {
		this.form = form;
	}
	 ...
	 */
	public void remove() {
		this.getManager().removeArchitecture();
	}
